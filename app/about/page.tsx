  ...
  return (
    <SiteShell>
      <main>
        ...
        <section className="py-14 bg-white">
          <div className="mx-auto max-w-[1200px] px-6 sm:px-8 lg:px-10">
            <h2 className="text-center text-2xl font-bold" style={{ color: '#049089' }}>關於娜米老師</h2>
        ...
        {/* ── 娜米創業歷程與活動經歷 ── */}
        <section className="py-14 bg-gray-50">
          <div className="mx-auto max-w-[800px] px-6 sm:px-8 lg:px-10">
            <h2 className="text-center text-2xl font-bold" style={{ color: '#049089' }}>娜米創業歷程與活動經歷</h2>
